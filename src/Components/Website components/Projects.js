...
import WHOLE from "../Photos/WHOLE.png";
...
function Projects() {
  const panes = [
          ...
          <Card.Group style={{ padding: "2em" }} centered>
            <Card>
              ...
              <Card.Content>
                ...
                <Card.Meta>
                  Autodesk Revit, Fusion360, Microsoft Office
                </Card.Meta>
                <Card.Description>
            ...
            <Card>
              ...
              <Card.Content>
                ...
                <Card.Description>
                  Designed and created landscaping plan for 881 San Jude Street
                  for contractor.
                </Card.Description>
              </Card.Content>
              <Card.Content extra>
    ...
    },
    {
      menuItem: "CAD",
      render: () => (
        <Tab.Pane style={{ alignItems: "center", textAlign: "center" }}>
          <Card.Group style={{ padding: "2em" }} centered>
            <Card>
              <Image
                style={{ margin: "auto", verticalAlign: "middle" }}
            ...
            <Card>
              ...
              <Card.Content>
                <Card.Header>
                  Reverse Engineering of Toy Sweeper Car
                </Card.Header>
          ...
          <Card.Group style={{ padding: "2em" }} centered>
            <Card>
              ...
              <Card.Content>
                ...
                <Card.Meta>
                  REACT, Semantic.ui, Gradient.ui, FontAwesome
                </Card.Meta>
                <Card.Description>
                  self-tuaght react from scratch.
                </Card.Description>
              </Card.Content>
              <Card.Content extra>
                <Link
        ...
        <Tab.Pane style={{ alignItems: "center", textAlign: "center" }}>
          <Card.Group style={{ padding: "2em" }} centered>
            <Card>
              ...
              <Card.Content>
                <Card.Header>
                  Built Electrical Bicycle from Scratch{" "}
                </Card.Header>
                <Card.Meta>
                  Microsoft Office, Hand Tools, Online and Local Bike Shop
                  Mentors
                </Card.Meta>
                <Card.Description>
                  Designed and Created Electrical Bicycle from scratch, for
                  parents commute
                </Card.Description>
              </Card.Content>
              <Card.Content extra>
